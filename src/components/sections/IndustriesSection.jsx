  ...
  return (
    <>
      <section id="industries" className="py-16 sm:py-24 bg-white text-slate-900 relative w-full overflow-hidden">
        ...
        <div className="max-w-[1700px] mx-auto px-4 sm:px-8 lg:px-14 xl:px-20 w-full mb-8 sm:mb-12 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-5 border-b border-slate-200">
            ...
            <p className="text-xs sm:text-[13px] text-slate-700 max-w-lg font-normal leading-relaxed">
