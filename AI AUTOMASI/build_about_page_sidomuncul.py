...
Fitur Pembaruan Sesuai Arahan User:
1. Garis Aliran Air HANYA MUNCUL saat masuk ke bagian Sejarah & Tahun (Slide 2004 dst).
2. Garis muncul mengalir dari BAWAH KE ATAS saat scroll dari Latar Belakang ke 2004.
3. Garis diletakkan di PALING BELAKANG (z-0 / background layer) di bawah seluruh aset konten (teks, foto, card z-20).
4. Desain garis dibuat jauh lebih ramping (6px), halus, elegan, dan menyatu alami dengan palet korporat KCA.
5. Animasi konten tetap staggered PowerPoint otomatis per fase.
...
print("BERHASIL: AboutPage.jsx diperbarui! Garis air hanya muncul saat masuk tahun, mengalir dari bawah ke atas, berada di background (z-0), dan menyatu dengan website!")
