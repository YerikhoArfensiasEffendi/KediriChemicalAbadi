...
export const STAIN_PROBLEMS = [
  {
    id: 'blood-medical',
    label: 'Darah, Serum & Cairan Medis',
    sector: 'medis',
    severity: 'Infeksius',
    desc: 'Noda hemoglobin darah dan eksudat luka pada linen kamar operasi dan rawat inap rumah sakit.',
    recommendedProducts: [
      { name: 'Alkali Booster Concentrate', sku: 'KCA-AB02', role: 'Pembuka pori serat & pelarut koagulasi protein', dose: '8 – 12 ml/kg', baseMl: 10, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' },
      { name: 'Liquid Detergent Non-Phosphate', sku: 'KCA-LD01', role: 'Surfaktan penetrasi inti serat noda', dose: '12 – 15 ml/kg', baseMl: 12.5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L, Drum 200L' },
      { name: 'Oxygen Bleach Liquid Color-Safe', sku: 'KCA-OB04', role: 'Oksigen aktif pengangkat noda darah & disinfeksi', dose: '8 – 10 ml/kg', baseMl: 8, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' },
      { name: 'Sour Neutralizer Anti-Chlor', sku: 'KCA-SN06', role: 'Penetral sisa alkali agar pH kain netral 6.5–7.0', dose: '2 – 3 ml/kg', baseMl: 2.5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L' }
    ],
    sopSteps: [
      { step: 1, name: 'Cold Flush (Bilas Dingin)', temp: 'Air Dingin 25–30°C', time: '3–5 Menit', note: 'Wajib air dingin untuk mencegah koagulasi protein hemoglobin darah.' },
      { step: 2, name: 'Main Wash (Alkali + Deterjen)', temp: '55 – 65°C', time: '12–15 Menit', note: 'Alkali Booster melunakkan hemoglobin, surfaktan menarik kotoran.' },
  ...
  {
    id: 'heavy-oil-grease',
    label: 'Oli Mesin Berat, Gemuk & Tar',
    sector: 'otomotif',
    severity: 'Industri',
    desc: 'Oli mineral hidrokarbon, grease sasis kendaraan berat, dan tar aspal pada wearpack bengkel.',
    recommendedProducts: [
      { name: 'Emulsifier Oil & Grease Remover', sku: 'KCA-EM03', role: 'Pelarut rantai hidrokarbon oli mineral', dose: '5 – 8 ml/kg', baseMl: 6, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L' },
      { name: 'Alkali Booster Concentrate', sku: 'KCA-AB02', role: 'Meningkatkan saponifikasi lemak & minyak mesin', dose: '10 – 15 ml/kg', baseMl: 12, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' },
      { name: 'Liquid Detergent Non-Phosphate', sku: 'KCA-LD01', role: 'Surfaktan pembersih residu jelaga karbon', dose: '12 – 15 ml/kg', baseMl: 12.5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L, Drum 200L' }
    ],
    sopSteps: [
  ...
  {
    id: 'hard-water',
    label: 'Air Sadah Tinggi (>350 ppm)',
    sector: 'laundry',
    severity: 'Operasional',
    desc: 'Kandungan kalsium & magnesium air tanah tinggi yang mematikan busa dan membuat kain kaku menguning.',
    recommendedProducts: [
      { name: 'Alkali Booster Concentrate', sku: 'KCA-AB02', role: 'Mengikat ion Ca²⁺ dan Mg²⁺ (Sequestering Complex)', dose: '10 – 15 ml/kg', baseMl: 12, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' },
      { name: 'Liquid Detergent Non-Phosphate', sku: 'KCA-LD01', role: 'Surfaktan non-ionik etoksilat tahan mineral sadah', dose: '12 – 15 ml/kg', baseMl: 12.5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L, Drum 200L' },
      { name: 'Sour Neutralizer Anti-Chlor', sku: 'KCA-SN06', role: 'Mencegah pengkristalan kapur di pori serat kain', dose: '3 – 5 ml/kg', baseMl: 3.5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L' }
    ],
    sopSteps: [
  ...
  },
  {
    ...
    label: 'Minyak Masak & Saus Bumbu',
    sector: 'fnb',
    severity: 'Komersial',
    desc: 'Lemak nabati/hewani, kecap, saus tomat, dan bumbu dapur pada taplak meja resto & seragam koki.',
    recommendedProducts: [
      { name: 'Emulsifier Oil & Grease Remover', sku: 'KCA-EM03', role: 'Emulsifikasi lemak jenuh & minyak goreng jelantah', dose: '4 – 6 ml/kg', baseMl: 5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L' },
      { name: 'Liquid Detergent Non-Phosphate', sku: 'KCA-LD01', role: 'Pengangkat noda protein & pigmen bumbu', dose: '10 – 12 ml/kg', baseMl: 10, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L, Drum 200L' },
      { name: 'Oxygen Bleach Liquid Color-Safe', sku: 'KCA-OB04', role: 'Pencerah warna motif taplak tanpa luntur', dose: '6 – 8 ml/kg', baseMl: 6, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' }
    ],
    sopSteps: [
  ...
  },
  {
    ...
    label: 'Linen Kusam & Menguning',
    sector: 'housekeeping',
    severity: 'Estetika',
    desc: 'Penumpukan residu deterjen curah, kapur air tanah, atau pemutih klorin berlebih pada sprei hotel.',
    recommendedProducts: [
      { name: 'Sour Neutralizer Anti-Chlor', sku: 'KCA-SN06', role: 'Iron sour pengangkat karat & pelarut residu garam', dose: '5 – 8 ml/kg', baseMl: 6, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L' },
      { name: 'Alkali Booster Concentrate', sku: 'KCA-AB02', role: 'Stripping build-up kimia lama pada serat kain', dose: '12 – 15 ml/kg', baseMl: 12, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' },
      { name: 'Oxygen Bleach Liquid Color-Safe', sku: 'KCA-OB04', role: 'Pencerah optik ramah serat (Optical Brightener)', dose: '10 ml/kg', baseMl: 10, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' }
    ],
    sopSteps: [
  ...
  {
    id: 'mold-musty-odor',
    label: 'Bau Apek & Jamur',
    sector: 'laundry',
    severity: 'Higienis',
    desc: 'Linen lembab terperangkap di keranjang cucian atau infeksi jamur bintik hitam akibat pengeringan kurang tuntas.',
    recommendedProducts: [
      { name: 'Oxygen Bleach Liquid Color-Safe', sku: 'KCA-OB04', role: 'Disinfektan oksidator pembasmi spora jamur', dose: '8 – 12 ml/kg', baseMl: 10, image: '/images/product_jerigen20l.jpg', packaging: 'Jerigen 20L, Drum 200L' },
      { name: 'Liquid Detergent Non-Phosphate', sku: 'KCA-LD01', role: 'Surfaktan pencuci penetrasi pori mikro kain', dose: '12 – 15 ml/kg', baseMl: 12.5, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L, Drum 200L' },
      { name: 'Fabric Softener Anti-Static', sku: 'KCA-FS05', role: 'Conditioner serat anti-statik & wangi tahan lama', dose: '5 – 8 ml/kg', baseMl: 6, image: '/images/product_jerigen5l.jpg', packaging: 'Jerigen 5L, 20L' }
    ],
    sopSteps: [
...
export const SECTORS_LIST = [
  ...
  { id: 'laundry', label: 'Laundry Komersial' },
  { id: 'medis', label: 'Rumah Sakit (KARS)' },
  { id: 'housekeeping', label: 'Hotel & Hospitality' },
  { id: 'fnb', label: 'F&B & Restoran' },
  { id: 'otomotif', label: 'Pabrik & Bengkel' },
]
